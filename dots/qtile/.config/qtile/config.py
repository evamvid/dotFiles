...
groups = [
    ...
    Group("3", matches=[Match(wm_class=["vscodium"])], label=""),
    Group("4", label=""),
    Group("5", label=""),
    ]
        ...
        top=bar.Bar(
            [
                ...
                widget.Wlan(background="bf6a6a", foreground="2e3440",
                            padding=4, interface="wlp0s20f3", format="{essid}"),
                widget.TextBox(text=' ', background="bf616a", foreground="2e3440", padding=2),
                widget.GenPollText(background="bf616a", foreground="2e3440", func=psutil.cpu_percent(), update_interval=5)
                widget.CPUGraph(
                    border_color="bf616a",
                    graph_color="bf616a",
                    border_width=1,
